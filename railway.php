...
<html >
    <head>
        ...
        <title>Railway | Letme Practice</title>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-6">
					<fieldset>	
						...
						Welcome to Railway</p></center></legend>
...
<div class="form-group">
		...
		<div class="form-group">
				<div class="col-xs-20">						
					<a href="searchyourexam.php">
					  <marquee onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 6, 0);">
					   <p style="color:red; font-size:20px;"><img src="img/takeexam.png" alt="Take Exam" height="42" width="42">Click Here for take Exam!</p>
